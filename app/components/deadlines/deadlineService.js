angular
    .module('Deadlines')
    .service('deadline', function deadline($http, $q, $rootScope, $window, urls, deadlineDistance) {
        ...
        deadline.saveTickList = function(list) {
            $window.localStorage['tickList'] = JSON.stringify(list);
        }

        deadline.getTickList = function() {
            var tickList = $window.localStorage['tickList'];
            if(tickList != null)
                return JSON.parse(tickList);
        }
